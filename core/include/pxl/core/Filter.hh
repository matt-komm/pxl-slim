...
/** 
 ...
 \p comparetype. 
 */
template<class comparetype> class ComparatorInterface
{
public:
 ...
 */
template<class objecttype> class FilterCriterionInterface
{
public:
...
public:
	...
	virtual size_t apply(const ObjectOwner& objects,

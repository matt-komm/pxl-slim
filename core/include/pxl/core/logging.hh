...
#define PXL_LOG_ERROR if (LogDispatcher::instance().getLowestLogLevel() > pxl::LOG_LEVEL_ERROR) {} else pxl::LogBuffer(pxl::LOG_LEVEL_ERROR, PXL_LOG_MODULE_NAME)
#define PXL_LOG_WARNING if (LogDispatcher::instance().getLowestLogLevel() > pxl::LOG_LEVEL_WARNING) {} else pxl::LogBuffer(pxl::LOG_LEVEL_WARNING, PXL_LOG_MODULE_NAME)
#define PXL_LOG_INFO if (LogDispatcher::instance().getLowestLogLevel() > pxl::LOG_LEVEL_INFO) {} else pxl::LogBuffer(pxl::LOG_LEVEL_INFO, PXL_LOG_MODULE_NAME)
#define PXL_LOG_DEBUG if (LogDispatcher::instance().getLowestLogLevel() > pxl::LOG_LEVEL_DEBUG) {} else pxl::LogBuffer(pxl::LOG_LEVEL_DEBUG, PXL_LOG_MODULE_NAME)

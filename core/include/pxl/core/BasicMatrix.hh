...
public:
	...
	BasicMatrix(size_t size1, size_t size2, std::string name = "BasicMatrix") : Serializable(), _size1(size1), _size2(size2), _storageType(ROWMAJOR), _alienarray(false), _name(name)
	{
		_data = new double[size1*size2];
		std::fill_n(_data, size1*size2, 0 );
	}

	BasicMatrix(size_t size1, size_t size2, StorageOrder storage, const std::string name = "BasicMatrix") : Serializable(), _size1(size1), _size2(size2), _storageType(storage), _alienarray(false), _name(name)
	{
		_data = new double[size1*size2];
		std::fill_n(_data, size1*size2, 0 );
	}
	...
	BasicMatrix(size_t size1, size_t size2, double *data, StorageOrder storage, const std::string name = "BasicMatrix") : Serializable(), _size1(size1), _size2(size2), _storageType(storage), _alienarray(true), _name(name), _data(data)
	{
	}

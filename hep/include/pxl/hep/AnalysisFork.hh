...
public:
	...
	/// The optional parameter \p input is a const pointer to a pxl::Serializable (which can be any serializable PXL object).
	...
	/// The optional parameter \p input is a const pointer to a pxl::Event (that might carry the reconstructed event data or generator information).
	/// By default, this method invokes the corresponding method of all managed pxl::AnalysisProcess instances,
	/// passing the parameter \p event to the according method of each instance.
